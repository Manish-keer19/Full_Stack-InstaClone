...
//     const data = { file, caption, location };
//     console.log("data is ", data);
//     try {
//       const res = await PostServiceInstance.createPost(data);
...
//         {image1 ? (
//           <Image1 source={{ uri: image1 }} style={styles.selectedImage1} />
//         ) : (
  ...
  const handleSubmit = async () => {
    ...
    if (file1 && file1.uri) {
      const fileToUpload = {
        ...
        type: file1.mediaType === "photo" ? "image/jpeg" : file1.mediaType, // Default type for photos
